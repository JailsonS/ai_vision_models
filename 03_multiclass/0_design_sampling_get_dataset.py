...
ASSET_SEEDS_REFERENCE = 'projects/ee-mapbiomas-imazon/assets/lulc/reference_map/samples_seeds_strat'
...
seeds_reference = ee.FeatureCollection(ASSET_SEEDS_REFERENCE)
...
list_pts = [x['coordinates'] for x in list_pts]


random.shuffle(list_pts)


train_size = int(len(list_pts) * TRAIN_RATIO)
vali_size = int(len(list_pts) * VAL_RATIO)
...
for type, data in items.items():
    export(data, f'{PATH_DIR}/data/{type}.tfrecord')