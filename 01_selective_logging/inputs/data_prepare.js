...
var REFENCE = ee.FeatureCollection(assetSamplesInput).map(function(feat){
...
var App = {
  ...
  timeLapseOnClick: function(id){
    ...
    var simex = ee.FeatureCollection(assetSamplesInput)
  ...
  finishEdition: function(){
      ...
      var exportParams = {
        ...
        assetId: assetSamplesOutput,
      };
    
      
      ee.data.deleteAsset(assetSamplesOutput, function() {
        // Executa a exportação
